...
from plugins.newEntry import NewEntryPlugin
from plugins.getDebateStatus import DebateStatusPlugin
...
class PluginManager:
    ...
    def __init__(self, config):
        ...
        plugin_mapping = {
            'newEntry': NewEntryPlugin,
            'getDebateStatus': DebateStatusPlugin,
